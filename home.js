...
window.searchUser = async function() {
  ...
  try {
    ...
    if (snap.empty) {
      resultDiv.innerHTML = '<p style="color:red">Utilisateur introuvable !</p>';
      return;
    }
    const userData = snap.docs[0].data();
    if (userData.uid === currentUser.uid) {
      resultDiv.innerHTML = '<p style="color:red">C\'est toi-même !</p>';
      return;
    }
    resultDiv.innerHTML = `
    ...
    resultDiv.innerHTML = '<p style="color:red">Erreur !</p>';
  }
}
